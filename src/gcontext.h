...
class GraphicsContext
{
	public:
        ...
        virtual void setPixel(int x, int y, double alpha) = 0;
        ...
        void bDrawLine(int x0, int y0, int x1, int y1);
        ...
        void xDrawLine(double x0, double y0, double x1, double y1);
         ...
         * from Wikipedia.org, http://en.wikipedia.org/wiki/Midpoint_circle_algorithm retrieved 8 January 2012)
         *
        ...
        virtual void mDrawCircle(int x0, int y0, unsigned int radius);
